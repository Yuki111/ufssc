...
public abstract class MyFilter extends Filter{
  ...
  public String getRevision() {
    return RevisionUtils.extract("$Revision: 12377 $");
  }
  ...
  protected void setOutputFormat(Instances outputFormat) {
    ...
    if (outputFormat != null) {
      setM_OutputFormat(outputFormat.stringFreeStructure());
      initOutputLocators(getM_OutputFormat(), null);
      ...
      getM_OutputFormat().setRelationName(relationName);
    } else {
      setM_OutputFormat(null);
    }
  ...
  protected void push(Instance instance, boolean copyInstance) {
    ...
    if (instance != null) {
      ...
      instance.setDataset(getM_OutputFormat());
  ...
  protected void copyValues(Instance instance, boolean isInput) {
    ...
    RelationalLocator.copyRelationalValues(instance,
      (isInput) ? m_InputFormat : getM_OutputFormat(),
  ...
  public Instances getOutputFormat() {
    ...
    return new Instances(getM_OutputFormat(), 0);
  }
  ...
  public boolean batchFinished() throws Exception {
    ...
    if (m_OutputQueue.empty()) {
      ...
      if ((m_OutputStringAtts.getAttributeIndices().length > 0)
        ...
        setM_OutputFormat(getM_OutputFormat().stringFreeStructure());
        m_OutputStringAtts = new StringLocator(getM_OutputFormat(),
...
public Instances getM_OutputFormat() {
	return m_OutputFormat;
}

public void setM_OutputFormat(Instances m_OutputFormat) {
	this.m_OutputFormat = m_OutputFormat;
}
}
